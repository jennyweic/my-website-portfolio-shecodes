...
<div className="Projects-container">
    ...
    <div className="Project-secondary-items">
     <div className="item">
       ...
       <div><video controls>
            <source src="assets/Jwei-Recipes.mov" type="video/mov"alt="Jwei-recipes-app"/>
            </video></div> 
...
<div>
    <video controls>
        <source src="/assets/Fitness.mov" type="video/mov" alt="Fitness-website"/>
    </video>
</div>
        ...
        <div>
    <video controls>
        <source src="/assets/Weather.mov" type="video/mov" alt="Weather-app"/>
    </video>
</div>
      ...
      <div className="item">
        ...
        <div>
    <video controls>
        <source src="/assets/World-Clock.mov" type="video/mov" alt="World-clock"/>
    </video>
</div>
